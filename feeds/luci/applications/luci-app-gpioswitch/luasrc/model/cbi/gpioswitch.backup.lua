...
gpios[1] = {name =  "0 PULLUP#",
            ...
            off1 = "echo in > /sys/class/gpio/gpio71/direction", 
            off2 = "echo 0 > /dev/null" }
...
gpios[3] = {name = "1 PULLUP#",
            ...
            off1 = "echo in > /sys/class/gpio/gpio68/direction", 
            off2 = "echo 0 > /dev/null" }
...
gpios[5] = {name = "2 PULLUP#",
            ...
            off1 = "echo in > /sys/class/gpio/gpio74/direction",
            off2 = "echo 0 > /dev/null"}
...
gpios[7] = {name = "3 PULLUP#",
            ...
            off1 = "echo in > /sys/class/gpio/gpio64/direction",
            off2 = "echo 0 > /dev/null"}
